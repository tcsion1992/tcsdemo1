...
import in.ion.tcsiondemo.om.TurbineRolePermission;
import in.ion.tcsiondemo.om.TurbineRolePermissionPeer;
    ...
    implements TurbineRole
{
     ...
     */
    protected List<in.ion.tcsiondemo.om.TurbineUserGroupRole> getTurbineUserGroupRolesJoinTurbineGroup(Criteria criteria, Connection con)
        throws TorqueException
    {
	...
	public void retrieveAttachedObjects(Connection con) throws TorqueException
    {
        ...
        List<in.ion.tcsiondemo.om.TurbineUserGroupRole> ugrs = getTurbineUserGroupRolesJoinTurbineGroup(new Criteria(), con);
